...
<body>
        ...
        <section class="page">
            <div class="sec1">
                <div class="left">
                    <div class="up">
                        <img class="img" src="../../images/depositphotos2.jpg" alt="Image loading failed" style="width:200px;height:200px; border-radius: 50%;" >
                    </div>
                    ...
                    <div class="down">
                        ...
                        <ul>
                            ...
                            <li><a href="student_my_profile.php"><i class="fa-solid fa-user"></i>  My Profile</a></li>
                ...
                <div class="right">
                    ...
                    <div class="catagory">
                        ...
                        <button class="button button1">Enrolled Courses</button>
                        <button class="button button2">Active Courses</button>
                        <button class="button button3">Complete Courses</button>
